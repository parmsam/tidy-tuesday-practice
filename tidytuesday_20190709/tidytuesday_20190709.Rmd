...
wwc_outcomes %>% filter(str_detect(round,regex("Final"))) %>% 
  ...
  geom_point( color="orange", size=4) + coord_flip() +
    labs(
    title="Appearances in Womens Soccer Finals (Semi, Quarter, or Grand Finals)",
    y="Number of Appearances",
    x="Country"
  )
ggsave("myplot1_20190709.png", width =15 , height=7)
```
...
ggsave("myplot2_20190709.png", width =15 , height=7)
```
